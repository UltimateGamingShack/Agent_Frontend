...
const Login_Password:React.FC=()=>{
    const [formData, setFormData] = useState<PasswordLogin>({
        agencyCode:"",
        password:""
    });
    ...
    const handleLogin = async()=>{
        try{
            const response = await axios.post("http://locahost:9500/newgenagent/agent/auth/login", formData);
                    ...
                    <form>
                        <div className="card-body">
                            ...
                            <div className="form-group">
                                ...
                                <input type="password" name="password" className="form-check" id="password" value={formData.password} onChange={handleChange} />
                            </div>
